...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="manager2.jsp">Manager View</a></li>
      <li><select id="mySelect" onchange="myFunction() style="width: 100px;">
  <option value="Audi"><font color="red">Audi</font></option>
  <option value="BMW">BMW</font></option>
  <option value="Mercedes">Mercedes</font></option>
  <option value="Volvo">Volvo</font></option>
...
<h2 align="center"><font><strong>Tokens</strong></font></h2></head>
	...
	<table  id="tbUser" align="center" width="20%" height="%30">
	<thead>
	<tr></tr>
	<tr>
		<td><b></b>
